...
![exploring channels](http://g.recordit.co/u58ZcPSZNZ.gif)

## What's Slack (not) good for?
Discussions usually start on Slack, as it provides a frictionless way of communicating.

But pay attention: as soon as they evolve into something more structured, it's a good practice to move them to some elsewhere, as Trello, GitHub, Paper, etc.
